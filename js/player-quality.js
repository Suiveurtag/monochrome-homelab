export const PLAYBACK_QUALITY_OPTIONS = [
    ...
    },
    {
        ...
        detail: '160 kb/s',
        targetBandwidth: 160_000,
        apiQuality: 'HIGH',
    },
    {
        id: 'HIGH',
        label: 'Very High',
        description: 'Best quality, more data',
        detail: '320 kb/s',
        targetBandwidth: 320_000,
        apiQuality: 'HIGH',
    },
    {
        id: 'LOSSLESS',
        label: 'Lossless',
        description: 'CD quality, lossless audio',
        detail: 'CD',
        targetBandwidth: 900_000,
        apiQuality: 'LOSSLESS',
    },
    {
        id: 'HI_RES_LOSSLESS',
        label: 'Hi-Res Lossless',
        description: 'Studio detail, lossless audio',
