// Monochrome adapter boundary. Status calculation remains the upstream code.
import { $currentLyricsType, LyricsObject, timeOffset, type LyricsType } from './runtime/RendererCompat.ts';
