...
let LetterScaleSpline = GetSpline($simpleLyricsMode.get() ? SimpleLetterScaleRange : LetterScaleRange);
...
let LetterYOffsetSpline = GetSpline($simpleLyricsMode.get() ? SimpleLetterYOffsetRange : LetterYOffsetRange);
